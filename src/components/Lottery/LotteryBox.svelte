<script lang="ts">
  import { isConnect, myAddress, CNDV2SaleContract, signer, CNDV2TotalSupply, myBalance, myNectarBalance } from '@/stores'
...
{#if checkIsSale}
  <div class="mintbox">
    <div class="boxcontent">
      ...
      <div class="subcontent">Notice: 1 Assets = 15,000 Nectar</div>
      <div class="subcontent">
        Your $Nectar balance: {$myNectarBalance}
      </div>
      {#if $isConnect && $myNectarBalance > lotteryValue}
        <div class="subbtn" on:click="{lotteryBtn}">
          <b> PULL UP </b>
        </div>
      {:else if $isConnect && $myNectarBalance < lotteryValue}
